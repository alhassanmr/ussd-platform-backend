...
public class NotificationService {
    ...
    private String welcomeTemplate(String name, String company) {
        return html("Welcome to " + appName + "!", String.format("""
            ...
            <p style="margin-top:16px">You're on the <strong>Free plan</strong> — 500 sessions/month included.</p>
            <a href="%s" style="display:inline-block;margin-top:24px;background:#111;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:500">
              Go to dashboard →
            </a>
    ...
    private String usageWarningTemplate(String company, int used, int limit, int pct) {
        ...
        return html("Usage Warning", String.format("""
            ...
            <a href="%s/billing" style="display:inline-block;margin-top:24px;background:#111;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none">
              Upgrade plan →
            </a>
    ...
    private String invoiceTemplate(String company, Invoice invoice) {
        return html("Invoice " + invoice.getInvoiceNumber(), String.format("""
            ...
            <table style="width:100%%;border-collapse:collapse;margin:20px 0">
              ...
              <tr>
                <td style="padding:12px;border-bottom:1px solid #f3f4f6">Monthly subscription</td>
                <td style="padding:12px;text-align:right;border-bottom:1px solid #f3f4f6">GHS %.2f</td>
              </tr>
              <tr>
                <td style="padding:12px;font-weight:600">Total</td>
                <td style="padding:12px;text-align:right;font-weight:600">GHS %.2f</td>
              </tr>
            </table>
    ...
    private String paymentFailedTemplate(String company, String invoiceNumber) {
        return html("Payment Failed", String.format("""
            ...
            <a href="%s/billing" style="display:inline-block;margin-top:24px;background:#dc2626;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none">
              Update payment →
            </a>
    ...
    private String cancellationTemplate(String company) {
        return html("Subscription Cancelled", String.format("""
            ...
            <a href="%s" style="display:inline-block;margin-top:24px;background:#111;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none">
              Resubscribe →
            </a>
    ...
    private String html(String title, String content) {
        return String.format("""
            ...
            <body style="font-family:system-ui,-apple-system,sans-serif;max-width:600px;margin:0 auto;padding:40px 24px;color:#111;background:#fff">
              <div style="margin-bottom:28px;padding-bottom:20px;border-bottom:2px solid #f3f4f6;display:flex;align-items:center;gap:10px">
              ...
              <div style="margin-top:40px;padding-top:20px;border-top:1px solid #f3f4f6;font-size:12px;color:#9ca3af">
                © %s · You received this because you have an account with us.
              </div>
            </body>
            </html>
